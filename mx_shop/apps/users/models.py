...
from  datetime import datetime  #python自带模块


from django.db import models
from django.contrib.auth.models import AbstractUser #第三方模块
...
class EmailVerifyRecord(models.Model):
    ...
    sent_time = models.DateTimeField(verbose_name='发送时间',default=datetime.now)
